...
//                ow.write(String.valueOf(5));   видимо у outputStream нет реализованных методов для
//                ow.write("\n");                переопределения int
//                ow.write(String.valueOf(i));
//                ow.write("\n");
//                ow.write(staticString);
//                ow.write("\n");
//
//                ow.close();               поток надо закрыть чтобы он отпустил фаайл для inputStream
